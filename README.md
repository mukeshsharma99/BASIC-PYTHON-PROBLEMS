...
16. Convert string to uppercase and lowercase.
...
22. Reverse a list without using reverse().
...
34. Find the difference between two sets.
35. Check if a set is a subset of another.

## Dictionaries
36. Create a dictionary and access its elements.
37. Count character frequency in a string using a dictionary.
38. Merge two dictionaries.
39. Sort a dictionary by key or value.
40. Invert keys and values in a dictionary.

## Loops & Conditions
41. Print all prime numbers between 1 and 100.
42. Generate patterns (pyramid, diamond, etc.).
43. Find all Armstrong numbers in a given range.
44. Create a number guessing game.
45. Display a multiplication table using a nested loop.
...
52. Create a class Rectangle to calculate area and perimeter.
53. Create a class Circle with a method to calculate area.
54. Create a class BankAccount with deposit and withdraw methods.
...
64. Use method overriding in a subclass.
...
## Abstraction
68. Create an abstract class Animal with an abstract method speak.
...
72. Build a class Employee with a method to calculate salary.
73. Create a class for a basic calculator.
74. Simulate a shopping cart using OOP.
75. Create a simple ATM machine simulation using OOP.
